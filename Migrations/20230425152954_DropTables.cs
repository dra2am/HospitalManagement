        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DoctorId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DoctorEmail = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    DoctorFirstName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    DoctorLastName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    DoctorPassword = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DoctorTitle = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientEmail = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    ...
                    PatientLastName = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    ...
                    PatientSSN = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Addresss_Patients_PatientId",
